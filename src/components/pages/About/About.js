import {Title , SubTitle , Desc , Img , Row} from '../../GlobelStyledComponents/GlobalStyle';
...
export default function About() {
  return (
     ...
     <div className="container-heading  text-center py-4">
         <Title>About</Title>
          ...
          <Row>
              <div className="row">
                  <div className="col-sm-6  py-5">
                       <Img src={myImage} width="50%" className="shadow-lg "/>
                  </div>
                  <div className="col-sm-6  py-5">
                     <Title>Hi, I'm Rishabh</Title>
                     <SubTitle>Frontend developer & Web designer</SubTitle>
                     <Desc>Through constant learning and creation , I product highly aesthetic website to highest standered
                         i'm largly framwork agnostic but technologies , i love right now React , React native , styled component.</Desc>
                       <div className="underline"></div>
                  </div>

                  <div className="col-sm-6 py-5">
                     <Title className="mt-5 text-uppercase">Skills</Title>
                     <SubTitle>Design </SubTitle>
                     <Desc>HTML / CSS / SCSS / REACT / STYLED COMPONENT</Desc>
                     <SubTitle>Development</SubTitle>
                     <Desc>NODE / MONGODB / EXPRESS / GIT / REACT NATIVE</Desc>
                  </div>
                   <div className="col-sm-6 py-3">
                              <svg className="svg" id="a2942aa7-bf0d-42c0-bc52-bf4c952347c5" data-name="Layer 1"
                           xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 925.497 645.18443">
                         ...
                         <path className="progressBox" d="M370.7485,300.40779v471h436v-471Zm218,34a15,15,0,1,1,15-15A15,15,0,0,1,588.7485,334.40779Z" transform="translate(-137.2515 -127.40779)" fill="#3f3d56"/>
                         <path d="M174.50646,731.20512c6.914,25.55824,30.59593,41.38709,30.59593,41.38709s12.47217-25.60922,5.55819-51.16745-30.59593-41.38709-30.59593-41.38709S167.59248,705.64689,174.50646,731.20512Z" transform="translate(-137.2515 -127.40779)" fill="#3f3d56"/>
                         <path d="M184.66607,725.71239c18.97207,18.46854,21.28937,46.859,21.28937,46.859s-28.4425-1.553-47.41457-20.02152-21.28937-46.859-21.28937-46.859S165.694,707.24384,184.66607,725.71239Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <rect x="16.497" y="643" width="909" height="2" fill="#3f3d56"/>
                         <path d="M329.2485,708.74592a22.03138,22.03138,0,0,0-14.03113-20.5,22,22,0,1,0-15.93774,0,21.99119,21.99119,0,0,0,0,41,22,22,0,1,0,15.93774,0A22.03137,22.03137,0,0,0,329.2485,708.74592Zm-42-41a20,20,0,1,1,24.51294,19.46735,22.02316,22.02316,0,0,0-9.02588,0A20.02094,20.02094,0,0,1,287.2485,667.74592Zm40,82a20,20,0,1,1-24.51294-19.46734,22.02362,22.02362,0,0,0,9.02588,0A20.02093,20.02093,0,0,1,327.2485,749.74592Zm-15.48706-21.53265a22.02316,22.02316,0,0,0-9.02588,0,19.97883,19.97883,0,0,1,0-38.93469,22.02362,22.02362,0,0,0,9.02588,0,19.97883,19.97883,0,0,1,0,38.93469Z" transform="translate(-137.2515 -127.40779)" fill="#3f3d56"/>
                         <path d="M648.2485,398.90779h-229a7,7,0,1,1,0-14h229a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#f2f2f2"/>
                         <path d="M648.2485,470.90779h-229a7,7,0,1,1,0-14h229a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#f2f2f2"/>
                         <path d="M648.2485,542.90779h-229a7,7,0,1,1,0-14h229a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#f2f2f2"/>
                         <path d="M648.2485,614.90779h-229a7,7,0,1,1,0-14h229a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#f2f2f2"/>
                         <path d="M648.2485,686.90779h-229a7,7,0,1,1,0-14h229a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#f2f2f2"/>
                         <path className="progressBar1" d="M608.2485,398.90779h-190a7,7,0,1,1,0-14h190a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <path className="progressBar2" d="M549.2485,470.90779h-131a7,7,0,1,1,0-14h131a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <path className="progressBar3" d="M477.2485,542.90779h-59a7,7,0,1,1,0-14h59a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <path className="progressBar4" d="M626.2485,614.90779h-208a7,7,0,1,1,0-14h208a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <path className="progressBar5" d="M580.2485,686.90779h-162a7,7,0,1,1,0-14h162a7,7,0,0,1,0,14Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <rect x="603.997" y="257.5" width="2" height="14" fill="#6c63ff"/>
                         <path  d="M758.2485,399.90779a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,758.2485,399.90779Zm0-14a6,6,0,1,0,6,6A6.00655,6.00655,0,0,0,758.2485,385.90779Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <rect x="603.997" y="329.5" width="2" height="14" fill="#6c63ff"/>
                         <path d="M758.2485,471.90779a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,758.2485,471.90779Zm0-14a6,6,0,1,0,6,6A6.00655,6.00655,0,0,0,758.2485,457.90779Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <rect x="603.997" y="401.5" width="2" height="14" fill="#6c63ff"/>
                         <path d="M758.2485,543.90779a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,758.2485,543.90779Zm0-14a6,6,0,1,0,6,6A6.00655,6.00655,0,0,0,758.2485,529.90779Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <rect x="603.997" y="473.5" width="2" height="14" fill="#6c63ff"/>
                         <path d="M758.2485,615.90779a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,758.2485,615.90779Zm0-14a6,6,0,1,0,6,6A6.00655,6.00655,0,0,0,758.2485,601.90779Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         <rect x="603.997" y="545.5" width="2" height="14" fill="#6c63ff"/>
                         <path d="M758.2485,687.90779a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,758.2485,687.90779Zm0-14a6,6,0,1,0,6,6A6.00655,6.00655,0,0,0,758.2485,673.90779Z" transform="translate(-137.2515 -127.40779)" fill="#6c63ff"/>
                         ...
                         <path d="M993.86505,511.88678v24.77488s5.96432,39.91507,5.96432,74.78342S990.1947,727.52,990.1947,727.52s-19.26935,6.88191-20.64573-3.67035-5.04673-66.52513-5.04673-74.78342-16.05779-71.11306-16.05779-71.11306L938.351,647.6898s3.21156,82.58291,0,84.87688-18.81055,6.42312-20.64573,2.294-11.46985-92.67638-11.46985-92.67638-7.79949-115.61608-3.21156-122.498,8.71709-12.38744,8.71709-12.38744S977.34847,491.24106,993.86505,511.88678Z" transform="translate(-137.2515 -127.40779)" fill="#2f2e41"/>
                         <path d="M987.90073,724.76719l1.15058,7.47874a73.664,73.664,0,0,1,.752,7.699c.17894,3.75694.80419,9.54528,2.94523,10.46287,3.21156,1.37638,24.05625,18.95588,9.37484,19.87347s-22.02612,2.50283-26.37484-.87347c-5.14118-3.99157.68238-2.18432-1.61159-2.18432s-5.04673,0-5.96432-3.67035,1.37638-10.09347,1.37638-10.09347V724.76719Z" transform="translate(-137.2515 -127.40779)" fill="#2f2e41"/>
                         <path d="M919.39674,724.40779l-1.15058,7.47874a73.6637,73.6637,0,0,0-.752,7.699c-.17894,3.75694-.80419,9.54528-2.94523,10.46286-3.21156,1.37639-24.05625,18.95589-9.37484,19.87348s22.02612,2.50283,26.37484-.87348c5.14118-3.99156-.68238-2.18431,1.61159-2.18431s5.04673,0,5.96432-3.67035-1.37638-10.09347-1.37638-10.09347V724.40779Z" transform="translate(-137.2515 -127.40779)" fill="#2f2e41"/>
                         <path d="M932.38666,312.7702s7.7995,19.26935,13.305,22.48091,2.75277,17.893,2.75277,17.893l-13.76382,19.26935H923.66957l-13.305-22.9397s-.91759-15.1402-3.67035-18.81055S932.38666,312.7702,932.38666,312.7702Z" transform="translate(-137.2515 -127.40779)" fill="#ffb9b9"/>
                         <path d="M932.38666,312.7702s7.7995,19.26935,13.305,22.48091,2.75277,17.893,2.75277,17.893l-13.76382,19.26935H923.66957l-13.305-22.9397s-.91759-15.1402-3.67035-18.81055S932.38666,312.7702,932.38666,312.7702Z" transform="translate(-137.2515 -127.40779)" opacity="0.1"/>
